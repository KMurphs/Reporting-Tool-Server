<template>
  ...
  <div class="data-unit" v-bind:id="'data-unit-' + sndata.sn">
    <input type="checkbox" class="data-unit__checkbox" v-bind:id="'data-unit__checkbox-' + sndata.sn">
    ...
    <a href="#" class="data-unit__link">
      <label v-bind:for="'data-unit__checkbox-' + sndata.sn" class="data-unit__label">
        <div class="data-unit__header">
          <span class="data-unit__header-item data-unit__body-state data-unit__body-state--opened">▼<!--alt 31--></span>
          <span class="data-unit__header-item data-unit__body-state data-unit__body-state--closed">►<!--alt 16--></span>
    ...
    <div class="data-unit__body-container">
      <div class="data-unit__body">
        <div class="data-unit__body-item data-unit__projectcode"><span class="data-unit__item--faded">Project Code: </span><span>{{  sndata.projectcode }}</span></div>
        <div class="data-unit__body-item data-unit__clientname"><span class="data-unit__item--faded">Client Name: </span><span>{{ sndata.client }}</span></div>
        <div class="data-unit__body-item data-unit__userinstruction data-unit__item--faded"><p> <br>Choose a Session from the list below</p></div>
        <SNUnitSession v-for="(sessionData, index) in sessionsData" 
